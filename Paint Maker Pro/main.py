...
class PaintApp(App):
    ...
    def build(self):
        ...
        self.save_btn_jpg = Button(text='Save as JPEG', background_color=btn_col,
    ...
    def save_canvas(self, for_kivy):
        filename = datetime.now().strftime(
            f'PMP_Drawing_at_%a_%b_%d_%I:%M:%S:%f_%p.jpg')
        ...
        self.rec_btn.background_color = self.btn_col
        self.cir_btn.background_color = self.btn_col
        popup.pop(filename, Label(text='Drawing saved.'))
